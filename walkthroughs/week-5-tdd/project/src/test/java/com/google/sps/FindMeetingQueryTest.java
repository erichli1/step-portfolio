...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredOptionalFullDay() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    // Optional attendee C has an all-day event
    //
    // Events  :       |--A--|     |--B--|
    //           |-------------C---------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void everyAttendeeIsConsideredOptionalPart() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    // Optional attendee C has an event between 8:30 and 9
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  public void justEnoughRoomOptional() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting.
    // Include conflict that has to be ignored
    //
    // Events  : |--A--|     |----A----|
    //                 |B|
    // Day     : |---------------------|
    ...
    reuqest.addOptionalAttendee(PERSON_B);
